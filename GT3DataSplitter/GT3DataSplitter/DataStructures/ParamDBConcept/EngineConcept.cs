...
{
    public class EngineConcept : CsvDataStructure<EngineConceptData, EngineConceptCSVMap>
    {
    }

    [StructLayout(LayoutKind.Sequential, Pack = 1)] // 0x58
    public struct EngineConceptData
    {
        public ulong Part;
        public ulong Car;
    ...
    public sealed class EngineConceptCSVMap : ClassMap<EngineConceptData>
    {
        public EngineConceptCSVMap()
        {
