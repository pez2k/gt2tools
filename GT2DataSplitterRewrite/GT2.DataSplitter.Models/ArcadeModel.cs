namespace GT2.DataSplitter.Models
{
    ...
    public class ArcadeModel
    {
        ...
        public TireCompoundArcade[] TireCompoundArcade { get; set; } = [];
        ...
        public EnemyCarsArcade[] EnemyCarsArcade { get; set; } = [];
        public CarArcadeRacing[] CarArcadeRacing { get; set; } = [];
        public CarArcadeDrift[] CarArcadeDrift { get; set; } = [];
    }
}