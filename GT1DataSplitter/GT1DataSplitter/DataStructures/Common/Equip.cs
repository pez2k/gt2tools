...
namespace GT1.DataSplitter
{
    ...
    public struct EquipData
    {
        ...
        public byte FrontDamperUnknown;
        public byte FrontDamperUnknown2;
        public byte FrontDamperUnknown3;
        public byte FrontDamperUnknown4;
    ...
    public sealed class EquipCSVMap : ClassMap<EquipData>
    {
        public EquipCSVMap()
        {
            ...
            Map(m => m.FrontDamperUnknown);
            Map(m => m.FrontDamperUnknown2);
            Map(m => m.FrontDamperUnknown3);
            Map(m => m.FrontDamperUnknown4);
